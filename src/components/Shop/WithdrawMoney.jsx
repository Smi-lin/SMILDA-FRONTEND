...
import { pass, withdraw } from "../../server";
...
const WithdrawMoney = () => {
  ...
  const deleteHandler = async () => {
    await axios
      .delete(`${pass}/deleteWithdrawMethod`, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const availableBalance = sellerId?.availableBalance;
          ...
          >
            ...
            {paymentMethod ? (
              ...
              <>
                ...
                {sellerId && sellerId?.withdrawMethod ? (
                  <div>
