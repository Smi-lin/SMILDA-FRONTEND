  ...
  return (
    <div className={`py-4 min-h-screen ${styles.section}`}>
      ...
      <div className="w-full flex items-center justify-between pt-6">
        <h5 className="text-[#00000084] ml-7">
          Order ID: <span>#{data?._id?.slice(0, 8)}</span>
        </h5>
        <h5 className="text-[#00000084] mr-7">
          ...
          return (
            <div className="w-full flex items-start mb-5 ">
              ...
              {!item.isReviewed ||item.status !== "delivered" ? null : (
                <div
                  className={`${styles.button} text-[#fff] mr-7`}
      ...
      <div className="w-full 800px:flex items-center">
        <div className="w-full 800px:w-[60%] ml-7">
      ...
      <br />
      <Link to="/">
        <div className={`${styles.button} text-white ml-7`}>Send Message</div>
      </Link>
      <br />
      <br />
    </div>
